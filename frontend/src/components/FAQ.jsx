...
const ITEMS = [
  ...
  },
  {
    ...
    a: 'На вход принимаются JPG, JPEG, PNG и WebP. На выход можно выбрать WebP (рекомендуется), JPEG или PNG. WebP даёт лучшее соотношение качества и размера.',
  },
  {
    q: 'Можно ли сжимать видео?',
    a: 'Пока нет — FileLite специализируется на изображениях. Поддержка видео появится в следующих версиях продукта.',
  },
  {
